    ...
    $(window).scroll(
        function () {
            ...
            if (m_st3 > m_po3&& m_st3<m_po1) {
                ...
                $(".nav>li:eq(1)").css("color","#F8E71C").siblings('li').css("color","#FFF");
            }else if(m_st3<= m_po3){
                $('.nav>li:eq(0)>i').fadeIn(500).parent("li").siblings('li').children('i').fadeOut();
                $(".nav>li:eq(0)").css("color","#F8E71C").siblings('li').css("color","#FFF");
                $('.nav>li:eq(1)>i').hide();
    ...
    $(window).scroll(
        function () {
            ...
            if (m_st1 >= m_po1&&m_st1<=m_po2) {
                ...
                $(".nav>li:eq(2)").css("color","#F8E71C").siblings('li').css("color","#FFF");
            }else{
    ...
    $(window).scroll(
        function () {
            ...
            if (m_st2 >= m_po2&&m_st2<=m_po4) {
                ...
                $(".nav>li:eq(3)").css("color","#F8E71C").siblings('li').css("color","#FFF");
            }else{
    ...
    $(window).scroll(
        function () {
            ...
            if (m_st4 >= m_po4&&m_st4<=m_po5) {
                ...
                $(".nav>li:eq(4)").css("color","#F8E71C").siblings('li').css("color","#FFF");
            }else{
                $('.nav>li:eq(4)>i').hide();
